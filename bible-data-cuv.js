// Complete Bible Data (Chinese Union Version)
...
const bibleDataCUV = {
  ...
  "Job": {
    "1": {
      ...
      "4": "他的兒子按着日子各在自己家裏設擺筵宴，就打發人去，請了他們的三個姐妹來，與他們一同吃喝。",
      "5": "筵宴的日子過了，約伯打發人去叫他們自潔。他清早起來，按着他們眾人的數目獻燔祭；因為他說：「恐怕我兒子犯了罪，心中棄掉神。」約伯常常這樣行。",
      ...
      "22": "在這一切的事上約伯並不犯罪，也不以神為愚妄〔或作：也不妄評神〕。"
    },
    "2": {
      ...
      "8": "約伯就坐在爐灰中，拿瓦片刮身體。",
      "9": "他的妻子對他說：「你仍然持守你的純正嗎？你棄掉神，死了吧！」",
      "10": "約伯卻對她說：「你說話像愚頑的婦人一樣。噯！難道我們從神手裏得福，不也受禍嗎？」在這一切的事上約伯並不以口犯罪。",
    ...
    "6": {
      ...
      "5": "野驢有草豈能叫喚？牛有料豈能吼叫？",
      "6": "物淡而無鹽豈可吃麼？蛋青有甚麼滋味呢？",
      "7": "看為可厭的食物，我心不肯挨近。",
      "8": "惟願我得着所求的，願神賜我所切望的；",
      "9": "就是願神把我壓碎，伸手將我剪除。",
      "10": "我因沒有違棄那聖者的言語，就仍以此為安慰，在不止息的痛苦中還可踊躍。",
    ...
    "11": {
      ...
      "4": "你說：我的道理純全；我在你眼前潔淨。",
      "5": "惟願神說話；願他開口攻擊你，",
      "6": "並將智慧的奧祕指示你；他有諸般的智識。所以當知道神追討你比你罪孽該得的還少。",
      ...
      "13": "你若將心安正，又向主舉手；",
      "14": "你手裏若有罪孽，就當遠遠的除掉，也不容非義住在你帳棚之中。",
    ...
    "15": {
      ...
      "23": "他漂流在外求食，說：那裏有食物呢？他知道黑暗的日子在他手邊預備好了。",
    ...
    "24": {
      ...
      "5": "這些貧窮人如同野驢出到曠野，殷勤尋找食物；他們靠着野地給兒女餬口，",
    ...
    "30": {
      ...
      "28": "我沒有日光就哀哭行去〔或作：我面發黑並非因日曬〕；我在會中站着求救。",
      "29": "我與野狗為弟兄，與鴕鳥為同伴。",
    ...
    "36": {
      ...
      "31": "他用這些審判眾民，且賜豐富的糧食。",
      "32": "他以電光遮手，命閃電擊中敵人〔或作：中了靶子〕。",
      "33": "所發的雷聲顯明他的作為，又向牲畜指明要起暴風。"
    },
    "37": {
      "1": "因此我心戰兢，從原處移動。",
      "2": "聽啊，神轟轟的聲音是他口中所發的響聲。",
      "3": "他發響聲震遍天下，發電光閃到地極。",
    ...
    "38": {
      ...
      "28": "雨有父嗎？露水珠是誰生的呢？",
      "29": "冰出於誰的胎？天上的霜是誰生的呢？",
      "30": "諸水堅硬〔或作：隱藏〕如石頭；深淵之面凝結成冰。",
      "31": "你能繫住昴星的結嗎？能解開參星的帶嗎？",
      "32": "你能按時領出十二宮嗎？能引導北斗和隨它的眾星〔星：原文作子〕嗎？",
    ...
    "40": {
      ...
      "14": "我就認你右手能以救自己。",
      "15": "你且觀看河馬；我造你也造牠。牠喫草與牛一樣；",
      "16": "它的氣力在腰間，能力在肚腹的筋上。",
      "17": "它搖動尾巴如香柏樹；牠大腿的筋互相聯絡。",
      "18": "它的骨頭好像銅管；牠的肢體彷彿鐵棍。",
      "19": "牠在神所造的物中為首；創造牠的給牠刀劍。",
      "20": "諸山給牠出食物，也是百獸遊玩之處。",
      "21": "它伏在蓮葉之下，臥在蘆葦隱密處和水窪子裏。",
      "22": "蓮葉的陰涼遮蔽牠；溪旁的柳樹環繞牠。",
      "23": "河水氾濫，牠不發戰；就是約但河的水漲到牠口邊，也是安然。",
    ...
    "41": {
      ...
      "12": "論到鱷魚的肢體和其大力，並美好的骨格，我不能緘默不言。",
      "13": "誰能剝牠的外衣？誰能進牠上下牙骨之間呢？",
      "14": "誰能開牠的腮頰？牠牙齒四圍是可畏的。",
      "15": "它以堅固的鱗甲為可誇，緊緊合閉，封得嚴密。",
      "16": "這鱗甲一一相連，甚至氣不得透入其間，",
      "17": "都是互相聯絡、膠結，不能分離。",
      "18": "它打噴嚏就發出光來；牠眼睛好像早晨的光線〔原文作眼皮〕。",
      "19": "從牠口中發出燒着的火把，與飛迸的火星；",
      "20": "從牠鼻孔冒出煙來，如燒開的鍋和點着的蘆葦。",
      "21": "它的氣點着煤炭，有火焰從牠口中發出。",
      "22": "它頸項中存着勁力；在牠面前的都恐嚇蹦跳。",
      "23": "它的肉塊互相聯絡，緊貼其身，不能搖動。",
      "24": "它的心結實如石頭，如下磨石那樣結實。",
      "25": "它一起來，勇士都驚恐，心裏慌亂，便都昏迷。",
      "26": "人若用刀，用槍，用標槍，用尖槍扎牠，都是無用。",
      "27": "它以鐵為乾草，以銅為爛木。",
      "28": "箭不能恐嚇牠使牠逃避；彈石在牠看為碎稭。",
      "29": "棍棒算為禾稭；牠嗤笑短槍颼的響聲。",
      "30": "它肚腹下如尖瓦片；牠如釘耙經過淤泥。",
      "31": "它使深淵開滾如鍋，使洋海如鍋中的膏油。",
      "32": "它行的路隨後發光，令人想深淵如同白髮。",
      "33": "在地上沒有像牠造的那樣，無所懼怕。",
    ...
    "42": {
      ...
      "10": "約伯為他的朋友祈禱。耶和華就使約伯從苦境〔原文作擄掠〕轉回，並且耶和華賜給他的比他從前所有的加倍。",
      "11": "約伯的弟兄、姐妹，和以先所認識的人都來見他，在他家裏一同喫飯；又論到耶和華所降與他的一切災禍，都為他悲傷安慰他。每人也送他一塊銀子和一個金環。",
